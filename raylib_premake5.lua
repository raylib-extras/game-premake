...
project "raylib"
    ...
    removefiles {raylib_dir .. "/src/rcore_android.c", raylib_dir .. "/src/rcore_custom.c", raylib_dir .. "/src/rcore_drm.c", raylib_dir .. "/src/rcore_web.c", raylib_dir .."/src/rcore_desktop.c"}
